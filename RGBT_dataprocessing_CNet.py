...
# gt 为png  其他两个为jpg格式
# Train NJU2K+LFSD
#os.listdir(path) 返回指定路径下所有文件和文件夹的名字，并存放于一个列表中。os.path.join()函数用于路径拼接文件路径，可以传入多个路径
lr = os.listdir('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/train/rgb')
lr = [os.path.join('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/train/rgb', img) for img in lr]
lr.sort()
gt = os.listdir('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/train/gt')
gt = [os.path.join('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/train/gt', gtimg) for gtimg in gt]
gt.sort()

depth = os.listdir('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/train/d')
depth = [os.path.join('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/train/d', dep) for dep in depth]
depth.sort()

bound = os.listdir('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/train/boundary')
bound = [os.path.join('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/train/boundary', edge) for edge in bound]
bound.sort()
...
# val NJU2K+LFSD
lrval = os.listdir('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/value/rgb')
lrval = [os.path.join('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/value/rgb', img) for img in lrval]
lrval.sort()


gtval = os.listdir('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/value/gt')
gtval = [os.path.join('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/value/gt', gtimg) for gtimg in gtval]
gtval.sort()

depthval = os.listdir('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/value/d')
depthval = [os.path.join('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/value/d', dep) for dep in depthval]
depthval.sort()



###Test
VT800_RGB = os.listdir('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/test/rgb')
VT800_RGB = [os.path.join('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/test/rgb', img) for img in VT800_RGB]
VT800_RGB.sort()

VT800_GT = os.listdir('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/test/gt')
VT800_GT = [os.path.join('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/test/gt', gtimg) for gtimg in VT800_GT]
VT800_GT.sort()

VT800_T = os.listdir('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/test/d')
VT800_T = [os.path.join('/media/pc12/data/hyt/rail_frame/Dataset/RGB_D_rail/test/d', dep) for dep in VT800_T]
VT800_T.sort()

############################################
# lr = os.listdir('/media/sunfan/date/Dataset/RGB_D_SOD/train/NJUNLPR/RGB')
# #lr = [os.path.join('/home/hjk/文档/轨道缺陷检测/Dataset/train/rgb', img) for img in lr]
# lr = [os.path.join('/media/sunfan/date/Dataset/RGB_D_SOD/train/NJUNLPR/RGB', img) for img in lr]
# lr.sort()
# # print(lr)
# #gt = os.listdir('/home/hjk/文档/轨道缺陷检测/Dataset/train/gt')
# gt = os.listdir('/media/sunfan/date/Dataset/RGB_D_SOD/train/NJUNLPR/GT')
# #gt = [os.path.join('/home/hjk/文档/轨道缺陷检测/Dataset/train/gt', gtimg) for gtimg in gt]
# gt = [os.path.join('/media/sunfan/date/Dataset/RGB_D_SOD/train/NJUNLPR/GT', gtimg) for gtimg in gt]
# gt.sort()
#
# #depth = os.listdir('/home/hjk/文档/轨道缺陷检测/Dataset/train/d')
# depth = os.listdir('/media/sunfan/date/Dataset/RGB_D_SOD/train/NJUNLPR/depth')
# #depth = [os.path.join('/home/hjk/文档/轨道缺陷检测/Dataset/train/d', dep) for dep in depth]
# depth = [os.path.join('/media/sunfan/date/Dataset/RGB_D_SOD/train/NJUNLPR/depth', dep) for dep in depth]
# depth.sort()
#
# #bound = os.listdir('/home/hjk/文档/轨道缺陷检测/Dataset/train/boundary')
# bound = os.listdir('/media/sunfan/date/Dataset/RGB_D_SOD/train/NJUNLPR/boundary')
# #bound = [os.path.join('/home/hjk/文档/轨道缺陷检测/Dataset/train/boundary', edge) for edge in bound]
# bound = [os.path.join('/media/sunfan/date/Dataset/RGB_D_SOD/train/NJUNLPR/boundary', edge) for edge in bound]
# bound.sort()
#
#
#
#
# # val NJU2K+LFSD
# #lrval = os.listdir('/home/hjk/文档/轨道缺陷检测/Dataset/value/rgb')
# lrval = os.listdir('/media/sunfan/date/Dataset/RGB_D_SOD/val/NJUNLPR/RGB')
# #lrval = [os.path.join('/home/hjk/文档/轨道缺陷检测/Dataset/value/rgb', img) for img in lrval]
# lrval = [os.path.join('/media/sunfan/date/Dataset/RGB_D_SOD/val/NJUNLPR/RGB', img) for img in lrval]
# lrval.sort()
#
#
# #gtval = os.listdir('/home/hjk/文档/轨道缺陷检测/Dataset/value/gt')
# gtval = os.listdir('/media/sunfan/date/Dataset/RGB_D_SOD/val/NJUNLPR/GT')
# #gtval = [os.path.join('/home/hjk/文档/轨道缺陷检测/Dataset/value/gt', gtimg) for gtimg in gtval]
# gtval = [os.path.join('/media/sunfan/date/Dataset/RGB_D_SOD/val/NJUNLPR/GT', gtimg) for gtimg in gtval]
# gtval.sort()
#
# #depthval = os.listdir('/home/hjk/文档/轨道缺陷检测/Dataset/value/d')
# depthval = os.listdir('/media/sunfan/date/Dataset/RGB_D_SOD/val/NJUNLPR/depth')
# #depthval = [os.path.join('/home/hjk/文档/轨道缺陷检测/Dataset/value/d', dep) for dep in depthval]
# depthval = [os.path.join('/media/sunfan/date/Dataset/RGB_D_SOD/val/NJUNLPR/depth', dep) for dep in depthval]
# depthval.sort()
#
#
#
# ###Test
# VT800_RGB = os.listdir('/media/sunfan/date/Dataset/RGB_D_SOD/test/NJU2K/RGB')
# VT800_RGB = [os.path.join('/media/sunfan/date/Dataset/RGB_D_SOD/test/NJU2K/RGB', img) for img in VT800_RGB]
# VT800_RGB.sort()
#
# VT800_GT = os.listdir('/media/sunfan/date/Dataset/RGB_D_SOD/test/NJU2K/GT')
# VT800_GT = [os.path.join('/media/sunfan/date/Dataset/RGB_D_SOD/test/NJU2K/GT', gtimg) for gtimg in VT800_GT]
# VT800_GT.sort()
#
# VT800_T = os.listdir('/media/sunfan/date/Dataset/RGB_D_SOD/test/NJU2K/depth')
# VT800_T = [os.path.join('/media/sunfan/date/Dataset/RGB_D_SOD/test/NJU2K/depth', dep) for dep in VT800_T]
# VT800_T.sort()

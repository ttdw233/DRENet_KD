...
def shunted_t(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(torch.load("/home/yuride/Documents/document/model/KD_model1/ckpt_T.pth"),
                             strict=False)
...
def shunted_s(pretrained=False, **kwargs):
    ...
    if pretrained:
        print("Load backbone weights")
        model.load_state_dict(torch.load("/home/user/Documents/HJK/backbone_yuride/Shunted/ckpt_B.pth"),
                             strict=False)
...
if __name__ == '__main__':
    ...
    y = torch.randn(2 ,1, 320, 320)
    net = shunted_b()
    load_state_dict = torch.load('/home/user/Documents/HJK/backbone/Shunted/ckpt_B.pth')
